...
import com.bajaj.model.impl.EmployeeImpl;
import com.bajaj.model.impl.EmployeeModelImpl;
import com.bajaj.service.persistence.EmployeePersistence;
...
public class EmployeePersistenceImpl
	...
	public List<Employee> findByEmployeeName(
		...
		return findByEmployeeName(name, start, end, orderByComparator, true);
	}
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			EmployeeModelImpl.AGE_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.bajaj.model.Employee"),
			true);
	}
