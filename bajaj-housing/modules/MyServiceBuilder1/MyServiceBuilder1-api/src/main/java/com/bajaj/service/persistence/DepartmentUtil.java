...
package com.bajaj.service.persistence;
...
public class DepartmentUtil {
	...
	public static Department findByUuid_First(
		...
		throws com.bajaj.exception.NoSuchDepartmentException {
	 ...
	 */
	public static Department create(long depId) {
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department remove(long depId)
		throws com.bajaj.exception.NoSuchDepartmentException {
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department findByPrimaryKey(long depId)
		throws com.bajaj.exception.NoSuchDepartmentException {
	 ...
	 */
	public static Department fetchByPrimaryKey(long depId) {
