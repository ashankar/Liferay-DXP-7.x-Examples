 ...
 * <code>com.bajaj.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.bajaj.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void callMyCustomQuery() {
		getService().callMyCustomQuery();
	}
	 ...
	 */
	public static Employee fetchEmployeeByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchEmployeeByUuidAndCompanyId(uuid, companyId);
	}
	 ...
	 */
	public static Employee getEmployeeByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getEmployeeByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Employee> getEmployeesWithDynamicQuery(
		String colName, String searchValue) {

		return getService().getEmployeesWithDynamicQuery(colName, searchValue);
	}
