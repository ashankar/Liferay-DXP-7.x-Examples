 ...
 * <code>com.bajaj.service.impl.DepartmentLocalServiceImpl</code> and
...
public class DepartmentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.bajaj.service.impl.DepartmentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Department createDepartment(long depId) {
		return getService().createDepartment(depId);
	}
	 ...
	 */
	public static Department deleteDepartment(long depId)
		throws PortalException {

		return getService().deleteDepartment(depId);
	}
	...
	public static Department fetchDepartment(long depId) {
		return getService().fetchDepartment(depId);
	}
	 ...
	 * @throws PortalException if a department with the primary key could not be found
	 */
	public static Department getDepartment(long depId) throws PortalException {
		return getService().getDepartment(depId);
	}
