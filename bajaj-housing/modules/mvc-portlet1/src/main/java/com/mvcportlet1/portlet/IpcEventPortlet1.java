...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/ipceventportlet1/view.jsp",
		"javax.portlet.name=" + MvcPortlet1PortletKeys.IPC_EVENT_PORTLET1,
		"javax.portlet.supported-publishing-event=id1;http://www.liferay.com"
	},
	service = Portlet.class
)
public class IpcEventPortlet1 extends MVCPortlet {
