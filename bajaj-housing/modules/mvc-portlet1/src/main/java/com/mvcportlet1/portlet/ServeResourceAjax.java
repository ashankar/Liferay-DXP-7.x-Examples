...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/serveresourceajax/view.jsp",
		"javax.portlet.name=" + MvcPortlet1PortletKeys.SERVE_RESOURCE_AJAX
	},
	service = Portlet.class
)
public class ServeResourceAjax extends MVCPortlet {
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			...
			System.out.println("Hello ServeResourceAjax serveResource-1");
