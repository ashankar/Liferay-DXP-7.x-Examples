...
/**
 * Provides the local service interface for XyzOrg. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see XyzOrgLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface XyzOrgLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link XyzOrgLocalServiceUtil} to access the xyz org local service. Add custom service methods to <code>com.sb2.training.service.impl.XyzOrgLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
