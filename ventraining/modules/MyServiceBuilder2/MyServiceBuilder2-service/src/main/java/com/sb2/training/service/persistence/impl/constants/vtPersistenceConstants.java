...
package com.sb2.training.service.persistence.impl.constants;
 ...
 * @generated
 */
public class vtPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME =
		"com.sb2.training.service";

	public static final String ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER =
		"(origin.bundle.symbolic.name=" + BUNDLE_SYMBOLIC_NAME + ")";

	static {
		Bundle bundle = FrameworkUtil.getBundle(vtPersistenceConstants.class);
