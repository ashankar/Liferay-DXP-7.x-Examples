...
import com.sb2.training.model.impl.EmployeeImpl;
import com.sb2.training.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	public Employee updateImpl(Employee employee) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				employeeModelImpl.getUuid(), employeeModelImpl.getCompanyId()
			};
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.sb2.training.model.Employee"),
			true);
	}
