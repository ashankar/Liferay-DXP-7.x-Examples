...
package com.mydb.sb.service.persistence.impl;
...
import com.mydb.sb.exception.NoSuchProductException;
import com.mydb.sb.model.Product;
import com.mydb.sb.model.impl.ProductImpl;
import com.mydb.sb.model.impl.ProductModelImpl;
import com.mydb.sb.service.persistence.ProductPersistence;
import com.mydb.sb.service.persistence.impl.constants.mytraindbPersistenceConstants;
...
public class ProductPersistenceImpl
	...
	@Override
	@Reference(
		target = mytraindbPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.mydb.sb.model.Product"),
			true);
	}
	...
	static {
		try {
			Class.forName(mytraindbPersistenceConstants.class.getName());
		}
