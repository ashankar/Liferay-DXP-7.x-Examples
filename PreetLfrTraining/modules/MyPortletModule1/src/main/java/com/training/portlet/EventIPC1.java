...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/eventipc1/view.jsp",
		"javax.portlet.name=" + MyPortletModule1PortletKeys.EVENT_IPC_1,
		"javax.portlet.supported-publishing-event=id1;http://www.liferay.com"
	},
	service = Portlet.class
)
public class EventIPC1 extends MVCPortlet {
