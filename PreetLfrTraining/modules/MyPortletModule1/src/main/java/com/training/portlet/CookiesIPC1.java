...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/cookiesipc1/view.jsp",
		"javax.portlet.name=" + MyPortletModule1PortletKeys.COOKIES_IPC1
	},
	service = Portlet.class
)
public class CookiesIPC1 extends MVCPortlet {
