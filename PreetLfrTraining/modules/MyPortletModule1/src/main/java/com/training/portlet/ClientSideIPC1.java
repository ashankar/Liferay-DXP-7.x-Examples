...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/clientsideipc1/view.jsp",
		"javax.portlet.name=" + MyPortletModule1PortletKeys.CLIENT_SIDE_IPC_1
	},
	service = Portlet.class
)
public class ClientSideIPC1 extends MVCPortlet {
	
	@Override
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {

		System.out.println("In ClientSideIPC1: doView");
