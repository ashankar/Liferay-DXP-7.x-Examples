...
<html class="${root_css_class}" dir="<@liferay.language key="lang.dir" />" lang="${w3c_language_id}">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="${themeDisplay.getPathThemeRoot()}/css/bootstrap.min.css" rel="stylesheet">

    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="${themeDisplay.getPathThemeRoot()}/css/fontawesome.css">
    <link rel="stylesheet" href="${themeDisplay.getPathThemeRoot()}/css/templatemo-finance-business.css">
    <link rel="stylesheet" href="${themeDisplay.getPathThemeRoot()}/css/owl.css">
<!--
...
<div class="navbar navbar-classic navbar-expand-md navbar-light pb-3">
    ...
    <div class="services">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="${themeDisplay.getPathThemeRoot()}/images/service_03.jpg" alt="">
              <div class="down-content">
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              ...
              <div class="partner-item">
                <img src="${themeDisplay.getPathThemeRoot()}/images/client-01.png" title="1" alt="1">
              </div>
              
              <div class="partner-item">
                <img src="${themeDisplay.getPathThemeImages()}/client-01.png" title="2" alt="2">
              </div>
              
              <div class="partner-item">
                <img src="${themeDisplay.getPathThemeImages()}/client-01.png" title="3" alt="3">
              </div>
              
              <div class="partner-item">
                <img src="${themeDisplay.getPathThemeImages()}/client-01.png" title="4" alt="4">
              </div>
              
              <div class="partner-item">
                <img src="${themeDisplay.getPathThemeImages()}/client-01.png" title="5" alt="5">
              </div>
    ...
    <script src="${themeDisplay.getPathThemeRoot()}/js/bootstrap.bundle.min.js"></script>

    <!-- Additional Scripts -->
    <script src="${themeDisplay.getPathThemeRoot()}/js/custom.js"></script>
    <script src="${themeDisplay.getPathThemeRoot()}/js/owl.js"></script>
    <script src="${themeDisplay.getPathThemeRoot()}/js/slick.js"></script>
    <script src="${themeDisplay.getPathThemeRoot()}/js/accordions.js"></script>
