package com.training.dynamic.jsp.override;
...
public class DynamicJspOverrideModule implements DynamicInclude {

	@Override
	public void include(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, String key)
			throws IOException {

		System.out.println("In DynamicJspOverrideModule: include");
	...
	public void register(DynamicIncludeRegistry dynamicIncludeRegistry) {
		...
		System.out.println("In DynamicJspOverrideModule: register");
