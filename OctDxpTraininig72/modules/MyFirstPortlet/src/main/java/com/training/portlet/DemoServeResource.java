...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/demoserveresource/view.jsp",
		"javax.portlet.name=" + MyFirstPortletKeys.DEMO_SERVE_RESOURCE
	},
	service = Portlet.class
)
public class DemoServeResource extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		System.out.println("In DemoServeResource: doView");
