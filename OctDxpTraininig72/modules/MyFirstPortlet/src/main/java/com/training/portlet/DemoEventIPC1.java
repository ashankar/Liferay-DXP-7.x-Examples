...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/demoeventipc1/view.jsp",
		"javax.portlet.name=" + MyFirstPortletKeys.DEMO_EVENT_IPC1,
		"javax.portlet.supported-publishing-event=id1;http://www.liferay.com"
	},
	service = Portlet.class
)
public class DemoEventIPC1 extends MVCPortlet {
	
	@Override
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {

		System.out.println("In DemoEventIPC1: doView");
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		System.out.println("In DemoEventIPC1: processAction");
