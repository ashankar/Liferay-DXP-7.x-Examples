...
<h1>This is overridden JSP!</h1>
<%=themeDisplay.getUser().getEmailAddress() %>



					<aui:fieldset>
						<aui:input autoFocus="<%= true %>" class="lfr-input-text-container" label="password" name="password1" id="password1" showRequiredLabel="<%= false %>" type="password">
							<aui:validator name="required" />
						</aui:input>

						<aui:input class="lfr-input-text-container" label="enter-again" name="password2" id="password2" showRequiredLabel="<%= false %>" type="password" oninput="myFunction();">
...
function myFunction() {
	...
	var x1= document.getElementById("password1").val;
	
  alert("The value of the input field was changed." + x1.value);
}
</script>
