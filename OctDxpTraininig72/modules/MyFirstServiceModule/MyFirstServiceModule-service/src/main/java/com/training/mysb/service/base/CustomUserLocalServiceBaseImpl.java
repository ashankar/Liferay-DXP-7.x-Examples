...
import com.training.mysb.service.CustomUserLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.training.mysb.service.impl.CustomUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.training.mysb.service.impl.CustomUserLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class CustomUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CustomUserLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustomUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.training.mysb.service.CustomUserLocalServiceUtil</code>.
	 */
	...
	public CustomUser createCustomUser(long id) {
		return customUserPersistence.create(id);
	}
	...
	public CustomUser deleteCustomUser(long id) throws PortalException {
		return customUserPersistence.remove(id);
	}
	...
	public CustomUser fetchCustomUser(long id) {
		return customUserPersistence.fetchByPrimaryKey(id);
	}
	...
	public CustomUser getCustomUser(long id) throws PortalException {
		return customUserPersistence.findByPrimaryKey(id);
	}
