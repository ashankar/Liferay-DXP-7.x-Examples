...
public interface CustomUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomUserLocalServiceUtil} to access the custom user local service. Add custom service methods to <code>com.training.mysb.service.impl.CustomUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CustomUser createCustomUser(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CustomUser deleteCustomUser(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomUser fetchCustomUser(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomUser getCustomUser(long id) throws PortalException;
