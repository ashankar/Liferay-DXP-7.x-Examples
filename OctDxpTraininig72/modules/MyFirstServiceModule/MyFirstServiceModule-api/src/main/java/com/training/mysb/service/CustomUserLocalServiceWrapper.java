...
public class CustomUserLocalServiceWrapper
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser addCustomUser(
	...
	@Override
	public void addLiferayUser(
		String firstName, String lastName, String email, String screenName,
		String password) {

		_customUserLocalService.addLiferayUser(
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser createCustomUser(long id) {
		return _customUserLocalService.createCustomUser(id);
	}
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser deleteCustomUser(
		com.training.mysb.model.CustomUser customUser) {
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser deleteCustomUser(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _customUserLocalService.deleteCustomUser(id);
	}
	...
	@Override
	public com.training.mysb.model.CustomUser fetchCustomUser(long id) {
		return _customUserLocalService.fetchCustomUser(id);
	}
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser getCustomUser(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _customUserLocalService.getCustomUser(id);
	}
	 ...
	 */
	@Override
	public java.util.List<com.training.mysb.model.CustomUser> getCustomUsers(
		int start, int end) {
	 ...
	 */
	@Override
	public com.training.mysb.model.CustomUser updateCustomUser(
		com.training.mysb.model.CustomUser customUser) {
