...
public class DoctorUtil {
	 ...
	 */
	public static Doctor create(long docId) {
	 ...
	 */
	public static Doctor remove(long docId)
		throws com.sb2.training.exception.NoSuchDoctorException {
	 ...
	 * @throws NoSuchDoctorException if a doctor with the primary key could not be found
	 */
	public static Doctor findByPrimaryKey(long docId)
		throws com.sb2.training.exception.NoSuchDoctorException {
	 ...
	 */
	public static Doctor fetchByPrimaryKey(long docId) {
	...
	private static ServiceTracker<DoctorPersistence, DoctorPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DoctorPersistence.class);

		ServiceTracker<DoctorPersistence, DoctorPersistence> serviceTracker =
			new ServiceTracker<DoctorPersistence, DoctorPersistence>(
				bundle.getBundleContext(), DoctorPersistence.class, null);
