...
/**
 * Provides the local service interface for Doctor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DoctorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DoctorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DoctorLocalServiceUtil} to access the doctor local service. Add custom service methods to <code>com.sb2.training.service.impl.DoctorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
