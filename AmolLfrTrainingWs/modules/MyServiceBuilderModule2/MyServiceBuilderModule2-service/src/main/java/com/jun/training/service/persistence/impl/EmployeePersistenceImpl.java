...
package com.jun.training.service.persistence.impl;

import com.jun.training.exception.NoSuchEmployeeException;
import com.jun.training.model.Employee;
import com.jun.training.model.impl.EmployeeImpl;
import com.jun.training.model.impl.EmployeeModelImpl;
import com.jun.training.service.persistence.EmployeePersistence;
import com.jun.training.service.persistence.impl.constants.amolsbPersistenceConstants;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByEmployeeName(String name, int start, int end) {
		return findByEmployeeName(name, start, end, null);
	}
	...
	public List<Employee> findByEmployeeName(
		...
		return findByEmployeeName(name, start, end, orderByComparator);
	}
	...
	public List<Employee> findByEmployeeName(
		...
		if (list == null) {
			...
			if (name.isEmpty()) {
				query.append(_FINDER_COLUMN_EMPLOYEENAME_NAME_3);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_EMPLOYEENAME_NAME_2);
			}
	...
	public Employee findByEmployeeName_First(
		...
		Employee employee = fetchByEmployeeName_First(name, orderByComparator);
	...
	public Employee fetchByEmployeeName_First(
		...
		List<Employee> list = findByEmployeeName(name, 0, 1, orderByComparator);
	...
	public Employee findByEmployeeName_Last(
		...
		Employee employee = fetchByEmployeeName_Last(name, orderByComparator);
	...
	public Employee fetchByEmployeeName_Last(
		...
		int count = countByEmployeeName(name);
	...
	public Employee[] findByEmployeeName_PrevAndNext(
		...
		try {
			...
			array[0] = getByEmployeeName_PrevAndNext(
				session, employee, name, orderByComparator, true);

			array[1] = employee;

			array[2] = getByEmployeeName_PrevAndNext(
				session, employee, name, orderByComparator, false);
	...
	protected Employee getByEmployeeName_PrevAndNext(
		Session session, Employee employee, String name,
	 ...
	 */
	@Override
	public void removeByEmployeeName(String name) {
	 ...
	 */
	@Override
	public int countByEmployeeName(String name) {
		name = Objects.toString(name, "");
	...
	private static final String _FINDER_COLUMN_EMPLOYEENAME_NAME_2 =
		"employee.name = ?";

	private static final String _FINDER_COLUMN_EMPLOYEENAME_NAME_3 =
		"(employee.name IS NULL OR employee.name = '')";
		...
		if (!_columnBitmaskEnabled) {
			...
			if ((employeeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					employeeModelImpl.getOriginalName()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByEmployeeName = new FinderPath(
			...
			EmployeeModelImpl.ADDRESS_COLUMN_BITMASK);
	...
	@Override
	@Reference(
		target = amolsbPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.jun.training.model.Employee"),
			true);
	}
	...
	static {
		try {
			Class.forName(amolsbPersistenceConstants.class.getName());
		}
