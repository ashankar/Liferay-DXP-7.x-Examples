...
import com.training.sb.model.OrganizationModel;
...
/**
 * The base model implementation for the Organization service. Represents a row in the &quot;mysb_Organization&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class OrganizationModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "mysb_Organization";

	public static final Object[][] TABLE_COLUMNS = {
		{"orgId", Types.BIGINT}, {"name", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table mysb_Organization (orgId LONG not null primary key,name VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table mysb_Organization";

	public static final String ORDER_BY_JPQL =
		" ORDER BY organization.orgId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY mysb_Organization.orgId ASC";
	...
	static {
		...
		attributeGetterFunctions.put("orgId", Organization::getOrgId);
		attributeSetterBiConsumers.put(
			"orgId", (BiConsumer<Organization, Long>)Organization::setOrgId);
	...
	public Object clone() {
		...
		organizationImpl.setOrgId(getOrgId());
	...
	public CacheModel<Organization> toCacheModel() {
		...
		organizationCacheModel.orgId = getOrgId();
