...
package com.sb.extdb.service.persistence.impl;
...
import com.sb.extdb.exception.NoSuchEmployeeException;
import com.sb.extdb.model.Employee;
import com.sb.extdb.model.impl.EmployeeImpl;
import com.sb.extdb.model.impl.EmployeeModelImpl;
import com.sb.extdb.service.persistence.EmployeePersistence;
import com.sb.extdb.service.persistence.impl.constants.amolextPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	@Override
	@Reference(
		target = amolextPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.sb.extdb.model.Employee"),
			true);
	}
	...
	static {
		try {
			Class.forName(amolextPersistenceConstants.class.getName());
		}
