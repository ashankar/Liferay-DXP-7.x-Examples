...
public class CustomControlPanelPanelApp2 extends BasePanelApp {

	@Override
	public String getPortletId() {
		return CustomControlPanelPortletKeys.CUSTOM_CONTROL_PANEL_PAGE_2;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + CustomControlPanelPortletKeys.CUSTOM_CONTROL_PANEL_PAGE_2 + ")",
		unbind = "-"
	)
