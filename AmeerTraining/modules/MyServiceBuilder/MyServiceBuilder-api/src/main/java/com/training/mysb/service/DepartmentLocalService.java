...
public interface DepartmentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DepartmentLocalServiceUtil} to access the department local service. Add custom service methods to <code>com.training.mysb.service.impl.DepartmentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Department createDepartment(String dpetId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Department deleteDepartment(String dpetId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department fetchDepartment(String dpetId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department getDepartment(String dpetId) throws PortalException;
