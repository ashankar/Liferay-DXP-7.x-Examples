...
public class DepartmentUtil {
	 ...
	 */
	public static Department create(String dpetId) {
		return getPersistence().create(dpetId);
	}
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department remove(String dpetId)
		throws com.training.mysb.exception.NoSuchDepartmentException {

		return getPersistence().remove(dpetId);
	}
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department findByPrimaryKey(String dpetId)
		throws com.training.mysb.exception.NoSuchDepartmentException {

		return getPersistence().findByPrimaryKey(dpetId);
	}
	 ...
	 */
	public static Department fetchByPrimaryKey(String dpetId) {
		return getPersistence().fetchByPrimaryKey(dpetId);
	}
