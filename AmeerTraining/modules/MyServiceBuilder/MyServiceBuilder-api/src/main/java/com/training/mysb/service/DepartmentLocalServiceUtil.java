 ...
 * <code>com.training.mysb.service.impl.DepartmentLocalServiceImpl</code> and
...
public class DepartmentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.training.mysb.service.impl.DepartmentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.training.mysb.model.Department addDepartment(
		com.training.mysb.model.Department department) {
	 ...
	 */
	public static com.training.mysb.model.Department createDepartment(
		String dpetId) {

		return getService().createDepartment(dpetId);
	}
	 ...
	 */
	public static com.training.mysb.model.Department deleteDepartment(
		com.training.mysb.model.Department department) {
	...
	public static com.training.mysb.model.Department deleteDepartment(
		...
		return getService().deleteDepartment(dpetId);
	}
	...
	public static com.training.mysb.model.Department fetchDepartment(
		String dpetId) {

		return getService().fetchDepartment(dpetId);
	}
	 ...
	 * @throws PortalException if a department with the primary key could not be found
	 */
	public static com.training.mysb.model.Department getDepartment(
			String dpetId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getDepartment(dpetId);
	}
	 ...
	 */
	public static java.util.List<com.training.mysb.model.Department>
	 ...
	 */
	public static com.training.mysb.model.Department updateDepartment(
		com.training.mysb.model.Department department) {
