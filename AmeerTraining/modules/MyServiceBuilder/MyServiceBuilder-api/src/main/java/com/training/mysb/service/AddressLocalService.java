...
public interface AddressLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddressLocalServiceUtil} to access the address local service. Add custom service methods to <code>com.training.mysb.service.impl.AddressLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Address createAddress(String addrId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Address deleteAddress(String addrId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Address fetchAddress(String addrId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Address getAddress(String addrId) throws PortalException;
