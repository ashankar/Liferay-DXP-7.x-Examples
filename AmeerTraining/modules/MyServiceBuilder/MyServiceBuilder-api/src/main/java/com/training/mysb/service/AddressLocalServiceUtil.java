 ...
 * <code>com.training.mysb.service.impl.AddressLocalServiceImpl</code> and
...
public class AddressLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.training.mysb.service.impl.AddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.training.mysb.model.Address addAddress(
		com.training.mysb.model.Address address) {
	 ...
	 */
	public static com.training.mysb.model.Address createAddress(String addrId) {
		return getService().createAddress(addrId);
	}
	 ...
	 */
	public static com.training.mysb.model.Address deleteAddress(
		com.training.mysb.model.Address address) {
	 ...
	 */
	public static com.training.mysb.model.Address deleteAddress(String addrId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteAddress(addrId);
	}
	...
	public static com.training.mysb.model.Address fetchAddress(String addrId) {
		return getService().fetchAddress(addrId);
	}
	 ...
	 * @throws PortalException if a address with the primary key could not be found
	 */
	public static com.training.mysb.model.Address getAddress(String addrId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getAddress(addrId);
	}
	 ...
	 */
	public static java.util.List<com.training.mysb.model.Address> getAddresses(
		int start, int end) {
	 ...
	 */
	public static com.training.mysb.model.Address updateAddress(
		com.training.mysb.model.Address address) {
