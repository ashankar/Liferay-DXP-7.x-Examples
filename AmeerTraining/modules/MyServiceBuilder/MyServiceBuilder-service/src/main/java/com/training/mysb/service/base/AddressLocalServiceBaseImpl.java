 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.training.mysb.service.impl.AddressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.training.mysb.service.impl.AddressLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class AddressLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.training.mysb.service.AddressLocalServiceUtil</code>.
	 */
	...
	public Address createAddress(String addrId) {
		return addressPersistence.create(addrId);
	}
	...
	public Address deleteAddress(String addrId) throws PortalException {
		return addressPersistence.remove(addrId);
	}
	...
	public Address fetchAddress(String addrId) {
		return addressPersistence.fetchByPrimaryKey(addrId);
	}
	...
	public Address getAddress(String addrId) throws PortalException {
		return addressPersistence.findByPrimaryKey(addrId);
	}
