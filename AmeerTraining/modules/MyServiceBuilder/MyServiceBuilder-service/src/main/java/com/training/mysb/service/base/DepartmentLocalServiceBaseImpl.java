...
public abstract class DepartmentLocalServiceBaseImpl
	...
	public Department createDepartment(String dpetId) {
		return departmentPersistence.create(dpetId);
	}
	...
	public Department deleteDepartment(String dpetId) throws PortalException {
		return departmentPersistence.remove(dpetId);
	}
	...
	public Department fetchDepartment(String dpetId) {
		return departmentPersistence.fetchByPrimaryKey(dpetId);
	}
	...
	public Department getDepartment(String dpetId) throws PortalException {
		return departmentPersistence.findByPrimaryKey(dpetId);
	}
