...
import com.training.mysb.exception.NoSuchAddressException;
import com.training.mysb.model.Address;
import com.training.mysb.model.impl.AddressImpl;
import com.training.mysb.model.impl.AddressModelImpl;
...
public class AddressPersistenceImpl
	...
	public Address[] findByUuid_PrevAndNext(
		...
		Address address = findByPrimaryKey(addrId);
	 ...
	 */
	@Override
	public Address create(String addrId) {
		Address address = new AddressImpl();

		address.setNew(true);
		address.setPrimaryKey(addrId);
	 ...
	 */
	@Override
	public Address remove(String addrId) throws NoSuchAddressException {
	 ...
	 */
	@Override
	public Address findByPrimaryKey(String addrId)
		throws NoSuchAddressException {
	 ...
	 */
	@Override
	public Address fetchByPrimaryKey(String addrId) {
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.training.mysb.model.Address"),
			true);
	}
