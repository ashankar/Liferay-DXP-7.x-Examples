...
public class EmployeeServiceSoap {
	...
	public static String getEmployeeThroughWs() throws RemoteException {
		try {
			String returnValue = EmployeeServiceUtil.getEmployeeThroughWs();
	...
	public static void createNewEmployeeRecord(long groupId, String empName)
		...
		try {
			EmployeeServiceUtil.createNewEmployeeRecord(groupId, empName);
		}
		catch (Exception e) {
			_log.error(e, e);
