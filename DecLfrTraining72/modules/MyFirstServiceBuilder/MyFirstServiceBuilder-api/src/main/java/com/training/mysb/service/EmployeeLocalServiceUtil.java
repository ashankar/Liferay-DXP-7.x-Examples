...
public class EmployeeLocalServiceUtil {
	 ...
	 */
	public static com.training.mysb.model.Employee createEmployee(long empId) {
	 ...
	 */
	public static com.training.mysb.model.Employee deleteEmployee(long empId)
	...
	public static com.training.mysb.model.Employee fetchEmployee(long empId) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static com.training.mysb.model.Employee getEmployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static java.util.List<com.training.mysb.model.Employee>
		getEmployeeByName(String name, String mobile) {

		return getService().getEmployeeByName(name, mobile);
	}
