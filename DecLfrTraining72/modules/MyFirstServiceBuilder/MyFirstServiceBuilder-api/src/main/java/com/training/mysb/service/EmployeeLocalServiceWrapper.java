...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee addEmployee(
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee createEmployee(long empId) {
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee deleteEmployee(
		com.training.mysb.model.Employee employee) {
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee deleteEmployee(long empId)
	...
	@Override
	public com.training.mysb.model.Employee fetchEmployee(long empId) {
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee getEmployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List<com.training.mysb.model.Employee> getEmployeeByName(
		...
		return _employeeLocalService.getEmployeeByName(name, mobile);
	}
	 ...
	 */
	@Override
	public java.util.List<com.training.mysb.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public com.training.mysb.model.Employee updateEmployee(
		com.training.mysb.model.Employee employee) {
