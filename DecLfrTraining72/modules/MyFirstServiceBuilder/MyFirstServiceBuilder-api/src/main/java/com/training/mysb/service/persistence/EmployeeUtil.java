...
public class EmployeeUtil {
	...
	/**
	 * Returns all the employees where name = &#63; and mobile = &#63;.
	 *
	 * @param name the name
	...
	public static List<Employee> findByEmployeeName(
		...
		return getPersistence().findByEmployeeName(name, mobile);
	}

	/**
	 * Returns a range of all the employees where name = &#63; and mobile = &#63;.
	 *
	 * <p>
	 ...
	 */
	public static List<Employee> findByEmployeeName(
		String name, String mobile, int start, int end) {

		return getPersistence().findByEmployeeName(name, mobile, start, end);
	}

	/**
	 * Returns an ordered range of all the employees where name = &#63; and mobile = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	...
	public static List<Employee> findByEmployeeName(
		...
		return getPersistence().findByEmployeeName(
			name, mobile, start, end, orderByComparator);
	}
	...
	public static List<Employee> findByEmployeeName(
		...
		return getPersistence().findByEmployeeName(
			name, mobile, start, end, orderByComparator, useFinderCache);
	}

	/**
	 * Returns the first employee in the ordered set where name = &#63; and mobile = &#63;.
	 *
	 * @param name the name
	 * @param mobile the mobile
	...
	public static Employee findByEmployeeName_First(
			String name, String mobile,
			OrderByComparator<Employee> orderByComparator)
		throws com.training.mysb.exception.NoSuchEmployeeException {

		return getPersistence().findByEmployeeName_First(
			name, mobile, orderByComparator);
	}
	...
	/**
	 * Returns the last employee in the ordered set where name = &#63; and mobile = &#63;.
	 *
	 * @param name the name
	 * @param mobile the mobile
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where name = &#63; and mobile = &#63;.
	 *
	...
	public static Employee[] findByEmployeeName_PrevAndNext(
			long empId, String name, String mobile,
			OrderByComparator<Employee> orderByComparator)
		throws com.training.mysb.exception.NoSuchEmployeeException {

		return getPersistence().findByEmployeeName_PrevAndNext(
			empId, name, mobile, orderByComparator);
	}

	/**
	 * Removes all the employees where name = &#63; and mobile = &#63; from the database.
	 *
	 * @param name the name
	 * @param mobile the mobile
	 */
	public static void removeByEmployeeName(String name, String mobile) {
		getPersistence().removeByEmployeeName(name, mobile);
	}

	/**
	 * Returns the number of employees where name = &#63; and mobile = &#63;.
	 *
	 * @param name the name
	 * @param mobile the mobile
	 * @return the number of matching employees
	 */
	public static int countByEmployeeName(String name, String mobile) {
		return getPersistence().countByEmployeeName(name, mobile);
	}
