...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByEmployeeName(String name, String mobile) {
		return findByEmployeeName(
			name, mobile, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Employee> findByEmployeeName(
		...
		return findByEmployeeName(name, mobile, start, end, null);
	}
	...
	public List<Employee> findByEmployeeName(
		...
		return findByEmployeeName(
			name, mobile, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByEmployeeName(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {name, mobile};
			}
		}
			...
			if ((list != null) && !list.isEmpty()) {
				for (Employee employee : list) {
					if (!name.equals(employee.getName()) ||
						!mobile.equals(employee.getMobile())) {
		...
		if (list == null) {
			...
			if (name.isEmpty()) {
				sb.append(_FINDER_COLUMN_EMPLOYEENAME_NAME_3);
			}
			else {
				bindName = true;

				sb.append(_FINDER_COLUMN_EMPLOYEENAME_NAME_2);
			}

			boolean bindMobile = false;

			if (mobile.isEmpty()) {
				sb.append(_FINDER_COLUMN_EMPLOYEENAME_MOBILE_3);
			}
			else {
				bindMobile = true;

				sb.append(_FINDER_COLUMN_EMPLOYEENAME_MOBILE_2);
			}
	...
	public Employee fetchByEmployeeName_First(
		...
		List<Employee> list = findByEmployeeName(
			name, mobile, 0, 1, orderByComparator);
	...
	public Employee fetchByEmployeeName_Last(
		...
		int count = countByEmployeeName(name, mobile);
		...
		List<Employee> list = findByEmployeeName(
			name, mobile, count - 1, count, orderByComparator);
	...
	public Employee[] findByEmployeeName_PrevAndNext(
		...
		try {
			...
			array[0] = getByEmployeeName_PrevAndNext(
				session, employee, name, mobile, orderByComparator, true);

			array[1] = employee;

			array[2] = getByEmployeeName_PrevAndNext(
				session, employee, name, mobile, orderByComparator, false);
	...
	protected Employee getByEmployeeName_PrevAndNext(
		Session session, Employee employee, String name, String mobile,
	...
	public int countByEmployeeName(String name, String mobile) {
		...
		Object[] finderArgs = new Object[] {name, mobile};
	...
	private static final String _FINDER_COLUMN_EMPLOYEENAME_MOBILE_2 =
		"employee.mobile = ?";

	private static final String _FINDER_COLUMN_EMPLOYEENAME_MOBILE_3 =
		"(employee.mobile IS NULL OR employee.mobile = '')";
	...
	public Employee updateImpl(Employee employee) {
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {
				employeeModelImpl.getName(), employeeModelImpl.getMobile()
			};
			...
			if ((employeeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					...
					employeeModelImpl.getOriginalMobile()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByEmployeeName = new FinderPath(
			...
			EmployeeModelImpl.MOBILE_COLUMN_BITMASK);
	...
	@Override
	@Reference(
		target = mysbnsPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
