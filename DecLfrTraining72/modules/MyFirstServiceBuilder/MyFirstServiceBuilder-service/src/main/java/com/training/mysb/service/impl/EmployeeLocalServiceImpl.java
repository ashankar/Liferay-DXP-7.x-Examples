...
import com.training.mysb.exception.MyCustomGroupException;
...
//			 employee=  EmployeeUtil.fetchByEmployeeName_First(name, mobile, null);
			 
			 employees= EmployeeUtil.findByEmployeeName(name, mobile);
			 
			 System.out.println("before Exception");
			 
//			 throw new MyCustomGroupException("Hey you did something wrong!");
