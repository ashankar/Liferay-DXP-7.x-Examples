...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/myclientsideipctest1/view.jsp",
		"javax.portlet.name=" + MyPortlet1PortletKeys.MY_CLIENT_SIDE_IPC_TEST1
	},
	service = Portlet.class
)
public class MyClientSideIPCTest1 extends MVCPortlet {
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		System.out.println("MyClientSideIPCTest1 ServeResource, Param1: " + param1);
